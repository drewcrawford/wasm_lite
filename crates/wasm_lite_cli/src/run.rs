...
///
/// The endpoint is [`LOG_PATH`]; the two have to agree, which
/// `forwarder_posts_to_the_log_path` checks.
const CONSOLE_FORWARDER: &str = r#"
(() => {
...
/// [`MAX_REQUEST_BODY`] ends mid-record, and half a line under a mangled level
