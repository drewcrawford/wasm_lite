...
RUSTFLAGS="-C target-feature=+atomics,+bulk-memory,+mutable-globals \
 ...
 -C link-arg=--export=__stack_pointer -C link-arg=--export=__tls_size -C link-arg=--export=__wasm_init_tls" \
CARGO_TARGET_WASM32_UNKNOWN_UNKNOWN_RUNNER="$PWD/target/debug/wasm_lite run" \
