...
fn test_console_redirect_api_smoke() {
    ...
    remove_spawn_hook("wasm_lite_std::println_eprintln_console_redirect");
}

crate::async_test! {
    async fn test_console_redirect_emits_output_from_worker() {
        const HOOK_NAME: &str = "wasm_lite_std::println_eprintln_console_redirect";
        install_println_eprintln_console_hook();
